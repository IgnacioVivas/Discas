							...
							<div className="space-y-8">
								<div>
									...
									<p className="text-lg text-gray-700 leading-relaxed">
										Discas es el primer y único grupo organizado de Córdoba Capital destinado específicamente al
										rescate, rehabilitación y adopción de animales con discapacidad.
									</p>
								</div>

								<div className="space-y-6">
									<p className="text-gray-700 leading-relaxed">
										Nuestro trabajo nace del amor, la empatía y la convicción de que la discapacidad no limita el
										derecho a una vida digna, feliz y acompañada.
									</p>

									<p className="text-gray-700 leading-relaxed">
										Nos dedicamos a brindar segundas oportunidades a peluditos que muchas veces son invisibilizados:
										animales con parálisis, amputaciones, enfermedades crónicas o secuelas físicas que requieren
										cuidados especiales, pero que tienen intactas sus ganas de vivir, jugar y dar amor.
									</p>
