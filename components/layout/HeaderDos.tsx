	...
	return (
		<div className="h-screen w-full relative flex flex-col mb-32">
			...
			<div className="px-5 absolute inset-0 flex flex-col items-center justify-center">
				<h1 className="font-nunito text-4xl lg:text-6xl font-semibold text-white drop-shadow-md text-center px-4">
					{title}
				</h1>
				<p className="font-quicksand text-center text-lg lg:text-2xl mt-2 drop-shadow-sm font-medium text-white">
					{description}
				</p>
			</div>
			{/* </div> */}
