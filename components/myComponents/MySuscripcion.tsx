		...
		<div className={cn('flex flex-col gap-6', className)} {...props}>
			<Card className="p-10 bg-custom-red border-0">
				<CardHeader className="p-0">
					<CardTitle className={`text-2xl text-white font-poppins`}>SUSCRÍBETE AL NEWSLETTER</CardTitle>
				...
				<CardContent>
					...
					<form>
						<div className="flex flex-col gap-3">
							...
							<Button type="submit" className={`w-full bg-custom-yellow hover:bg-teal-950 font-nunito`}>
								Iniciar sesión
							</Button>
						</div>
					</form>
